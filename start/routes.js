...
Route.group(() => {
  ...
  Route.put('forgotpassword', 'ForgotPasswordController.update').validator('ForgotPassword/ForgotPasswordUpdate')

  // departments
  Route.get('departments', 'DepartmentController.index').middleware('can:read_departments')
  Route.get('departments', 'DepartmentController.show').middleware('can:read_departments') // faz que agora tu sabe fazer direito, tu fez na agenda
  Route.post('departments', 'DepartmentController.store').validator('Department').middleware('can:create_departments')
  Route.put('departments/:id', 'DepartmentController.update').validator('Department').middleware('can:update_departments')
  Route.delete('departments/:id', 'DepartmentController.destroy').middleware('can:delete_departments')
  ...
  Route.get('locales/:id', 'LocaleController.show').middleware('can:read_locales')
  Route.post('locales', 'LocaleController.store').middleware('can:create_locales')
  ...
  Route.get('checkouts/:id', 'CheckoutController.show').middleware('can:read_schedules')
  Route.put('checkouts/:id', 'CheckoutController.update').middleware('can:update_schedules')
}).middleware(['auth'])
